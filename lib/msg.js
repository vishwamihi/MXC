...
const sampandey001 = require('@sampandey001/baileys')
const fs = require('fs')
let proto;
...
let sessdata = config.SESSION_ID
        if(sessdata.startsWith('itzcp_qr-')){
			proto = sampandey001.proto
			downloadContentFromMessage = sampandey001.downloadContentFromMessage
			getContentType = sampandey001.getContentType
        }else if(sessdata.startsWith('itzcp_pair-')){
			proto = whiskeysockets.proto
			downloadContentFromMessage = whiskeysockets.downloadContentFromMessage
